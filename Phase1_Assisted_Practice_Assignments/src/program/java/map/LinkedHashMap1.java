...
public class LinkedHashMap1 {
	public static void main(String[] args){
		 ...
		 Map<Integer, String> linkedHashMap =  new LinkedHashMap<Integer, String>();
		    linkedHashMap.put(1, new String("orange"));
	        linkedHashMap.put(2, new String("apple"));
	        linkedHashMap.put(3, new String("kiwi"));
	        linkedHashMap.put(4, new String("mango"));
	        linkedHashMap.put(5, new String("pineapple"));
	        linkedHashMap.put(6, new String("cherry"));
	        linkedHashMap.put(7, new String("banana"));
	        linkedHashMap.put(8, new String("papaya"));
	        linkedHashMap.put(9, new String("grapes"));
	        linkedHashMap.put(10, new String("strawberry"));
